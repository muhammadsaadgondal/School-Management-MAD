  ...
  return (
    <View style={tw`flex-1 p-4 bg-white`}>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.5}
        onPress={() => navigation.navigate('ClassNavigation', { screen: 'ManageTeachers' })}
      >
      ...
      <TouchableOpacity
        style={tw`bg-indigo-700 p-4 rounded mb-4 z-10`}
        activeOpacity={0.5}
        onPress={() => navigation.navigate('StudentNavigation', { screen: 'ManageStudents' })}
      >
      ...
      <TouchableOpacity
        style={tw`bg-indigo-700 p-4 rounded mb-4 z-10`}
        activeOpacity={0.5}
        onPress={() => navigation.navigate('ClassNavigation', { screen: 'ManageClasses' })}
      >
